...
$(document).ready(function () {
    ...
    var totalForumCountUrl = app.Urls.totalForumCountUrl;
    var totalCommentCountUrl = app.Urls.totalCommentCountUrl;
    ...
    $.ajax({
        ...
        error: function () {
            toastr.error("Makale Analizleri yüklenirken bir hata oluştu", "Hata");
        }
    });
    ...
    $.ajax({
        ...
        error: function () {
            toastr.error("Kategori Analizleri yüklenirken bir hata oluştu", "Hata");
        }
    });
    ...
    $.ajax({
        ...
        error: function () {
            toastr.error("Kullanıcı Analizleri yüklenirken bir hata oluştu", "Hata");
        }
    });

    $.ajax({
        type: "GET",
        url: totalForumCountUrl,
        dataType: "json",
        success: function (data) {
            $("h3#totalForumCount").append(data);
        },
        error: function () {
            toastr.error("Forum Analizleri yüklenirken bir hata oluştu", "Hata");
        }
    });

    $.ajax({
        type: "GET",
        url: totalCommentCountUrl,
        dataType: "json",
        success: function (data) {
            $("h3#totalCommentCount").append(data);
        },
        error: function () {
            toastr.error("Yorum Analizleri yüklenirken bir hata oluştu", "Hata");
        }
    });
